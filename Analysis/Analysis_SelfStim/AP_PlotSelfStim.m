...
ax.XTick = [ 1 2];ax.XTickLabels = {'Laser','Sham Laser'};

subplot(2,2,3)
plot((Analysis.Bins(startBin:endBin-1)-Analysis.startPoke )/60, Analysis.PokeRates(1,startBin:endBin-1),'Color','blue');hold on
plot((Analysis.Bins(startBin:endBin-1)-Analysis.startPoke )/60, Analysis.PokeRates(2,startBin:endBin-1),'Color','red');
