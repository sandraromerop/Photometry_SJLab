...
%     LeftValveTime = R(1); RightValveTime = R(2); % Update reward amounts
    ...
    if S.GUI.RewardSide==1
        ...
        RightPokeAction = 'Punishment'; 
        valveTime = .5;     %GetValveTimes(S.GUI.RewardAmount, [4]); 
        portIn = 'Port4In';
        
    elseif S.GUI.RewardSide==2
        StimulusOutput = {'PWM6', 255};        
        LeftPokeAction = 'Punishment';
        RightPokeAction =  'RightRewardDelay'; 
        valveTime = .5;     %GetValveTimes(S.GUI.RewardAmount, [6]); 
        portIn = 'Port6In';
    end
    ...
    switch S.GUIMeta.Phase.String
        ...
        case 'Conditioned Reinforcerment'
            ...
            sma = AddState(sma, 'Name', 'LeftReward', ...
                ...
                'OutputActions', {'ValveState',valvePhysicalAddress(4) }); 
            
            sma = AddState(sma, 'Name', 'RightReward', ...
                'Timer', valveTime,...
                'StateChangeConditions', {'Tup', 'PostOutcome'},...
                'OutputActions', {'ValveState', valvePhysicalAddress(6) }); 
