...
%         easyTrials=[1 1 1 1 3 3 4 4];
    ...
    case 'RewardA'  % training
        trialsNames={'Cue A Reward','Cue A Omission',...
                     'Cue B Omission','Uncued Reward',...
                     'Uncued Omission','blank','OptoStim at CueA',...
                     'OptoStim at CueB','OptoStim at Reward',...
                     'OptoStim at Omission'};
%        trialsMatrix=[...
        % 1.type, 2.proba, 3.sound, 4.delay,    5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStim        10.OptoStimRwd
...
%             6,   0.0,       3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     2                   S.GUI.OptoStimCueDelay   0;...   % (CueA+ Stim) + reward 
%             7,   0.0,       3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     2                   S.GUI.OptoStimCueDelay   0;...   % (CueB+ Stim) + omission 
%             8,   0.0,       3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    2;...   %  CueA  + (reward + stim)
%             9,   0.0,       3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    2 ];    %  CueB  + (omission + stim)

       trialsMatrix=[...
%         1.type, 2.proba, 3.sound, 4.delay,    5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStim        10.OptoStimRwd
            1,   S.GUI.ProbCueARwd,             1,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,    double('o')     0                   1e-06                    0;...   % CueA: big reward trial
            2,   S.GUI.ProbCueAOmission,        1,    S.GUI.Delay,  S.GUI.OmissionValve, 	S.InterRew,    double('s')     0                   1e-06                    0;...   % CueA: omission
            3,   S.GUI.ProbCueBOmission,        2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    0;...   % CueB: omission
            4,   S.GUI.ProbUncuedRwd,           3,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,    double('o')     0                   1e-06                    0;...   % Uncued reward
            5,   S.GUI.ProbUncuedOmission  ,    3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    0;...   % No Cue + no reward
            6,   S.GUI.ProbCueAOpto,            3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     2                   S.GUI.OptoStimCueDelay   0;...   % (CueA+ Stim) + reward 
            7,   S.GUI.ProbCueBOpto,            3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     2                   S.GUI.OptoStimCueDelay   0;...   % (CueB+ Stim) + omission 
            8,   S.GUI.ProbCueARwdOpto,         3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    2;...   %  CueA  + (reward + stim)
            9,   S.GUI.ProbCueBOMissionOpto,    3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('s')     0                   1e-06                    2 ];    %  CueB  + (omission + stim)
