...
%% Assemble State matrix
    ...
    sma = SetGlobalTimer(sma,1, ...
        S.GUI.PreCue + S.OptoStimCueDelay + S.GUI.SoundDuration + S.Delay);
    % Timer Trig
    ...
    sma=AddState(sma,'Name', 'Delay',...
        'Timer',S.Delay-S.LickWindow,...
        'StateChangeConditions', { 'Tup','LickWindow'},...
        'OutputActions', {});
    %Lickwindow
    sma=AddState(sma,'Name', 'LickWindow',...
        'Timer',S.LickWindow,...
        'StateChangeConditions', {'Port1In', 'HitTrigger', 'Tup','Miss'},...
        'OutputActions', {});
    %Hit Trigger
    ...
    sma=AddState(sma,'Name', 'Miss',...
        'Timer',S.Outcome,...
        'StateChangeConditions', {'Tup', 'PostReward'},...
        'OutputActions', {'ValveState', 4 ,'BNCState',S.OptoStimRwd});  
    %Post task states
...
[currentOutcome, currentLickEvents,outcomeId]=Online_LickEvents(S.TrialsMatrix,currentTrial,TrialSequence(currentTrial),...
    S.Names.StateToZero{S.GUI.StateToZero});
...
if S.GUI.Photometry
    ...
    FigNidaq=Online_NidaqPlot('update',trialNamesPlot,[],FigNidaq,currentNidaq470,...
        currentNidaq405,nidaqRaw,trialTypePlot);
    %% 
    if S.GUI.DbleFibers == 1
