...
%         1.type, 2.proba,                      3.sound, 4.delay,   5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStimCue      10.OptoStimRwd
            1,   S.GUI.ProbCueARwd,             1,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewA,    double('o')     0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial
            2,   S.GUI.ProbCueAOmission,        1,    S.GUI.Delay,  S.GUI.OmissionValve, 	S.RewB,    double('s')     0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: omission
            3,   S.GUI.ProbCueBRwd,             2,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewC,    double('o')     0                   S.GUI.OptoStimCueDelay                    0;...   % CueB: omission
            4,   S.GUI.ProbCueBOmission,        2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.RewA,    double('s')     0                   S.GUI.OptoStimCueDelay                    0;...   % CueB: omission
            5,   S.GUI.ProbCueCOmission,        3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.RewB,    double('s')     0                   S.GUI.OptoStimCueDelay                    0;...   % CueB: omission
            6,   S.GUI.ProbUncuedRwd,           4,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewA,    double('o')     0                   S.GUI.OptoStimCueDelay                    0;...   % Uncued reward
            7,   S.GUI.ProbUncuedOmission  ,    4,    S.GUI.Delay,  S.GUI.OmissionValve,	S.RewA,    double('s')     0                   S.GUI.OptoStimCueDelay                    0;...   % No Cue + no reward
            8,   S.GUI.ProbCueAOpto,            1,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewA,    double('o')     2                   S.GUI.OptoStimCueDelay                    0;...   % (CueA+ Stim) + reward 
            9,   S.GUI.ProbCueBOpto,            2,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewB,    double('o')     2                   S.GUI.OptoStimCueDelay                    0;...   % (CueB+ Stim) + omission 
            10,  S.GUI.ProbCueCOpto,            3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.RewC,    double('s')     2                   S.GUI.OptoStimCueDelay                    0;...   % (CueB+ Stim) + omission 
            11,  S.GUI.ProbCueARwdOpto,         1,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewA,    double('o')     0                   S.GUI.OptoStimCueDelay                    2;...   %  CueA  + (reward + stim)
            12,  S.GUI.ProbCueBRwdOpto,         2,    S.GUI.Delay,  S.GUI.RewardValve,      S.RewB,    double('o')     0                   S.GUI.OptoStimCueDelay                    2;...   %  CueA  + (reward + stim)
            13,  S.GUI.ProbCueCOmissionOpto,    3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.RewC,    double('s')     0                   S.GUI.OptoStimCueDelay                    2 ];    %  CueB  + (omission + stim)
        %%%%%%%%%%%%%%%%%%%%%%    
...
%         1.type, 2.proba,                      3.sound, 4.delay,   5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStimCue      10.OptoStimRwd
            ...
            6,   S.GUI.ProbCueAOpto,            1,    S.GUI.Delay,  S.GUI.RewardValve,	S.InterRew,        double('d')     2                   S.GUI.OptoStimCueDelay                       0;...   % (CueA+ Stim) + reward 
            7,   S.GUI.ProbCueBOpto,            2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('d')     2                   S.GUI.OptoStimCueDelay                       0;...   % (CueB+ Stim) + omission 
            8,   S.GUI.ProbCueARwdOpto,         1,    S.GUI.Delay,  S.GUI.RewardValve,	S.InterRew,        double('d')     0                   S.GUI.OptoStimCueDelay                    2;...   %  CueA  + (reward + stim)
            9,   S.GUI.ProbCueBOmissionOpto,    2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,    double('d')     0                   S.GUI.OptoStimCueDelay                    2 ];    %  CueB  + (omission + stim)
