function CuedReward_Operant_TaskParameters(Param)

global S %BpodSystem
    listPhases= {'RewardOperant','RewardA','RewardB','RewardAPunishB','RewardBPunishA',...
    ...
    switch phaseName
        ...
        case 'RewardOperant'
            S.Names.Symbols={'Reward','Omission','Reward Opto','Cue Opto'};
    end
    ...
    switch S.GUIMeta.Phase.String
      %%%%%%%%%%%%%%%%%
        case 'RewardOperant'
                ...
                S.GUI.ProbCueCOpto= TrialSettings.ProbCueCOpto;
                S.GUI.ProbCueARwdOpto= TrialSettings.ProbCueARwdOpto;
                S.GUI.ProbCueBRwdOpto= TrialSettings.ProbCueARwdOpto;
                S.GUI.ProbCueCOmissionOpto= TrialSettings.ProbCueCOmissionOpto;
        S.GUIPanels.TaskSpecifics={'ProbCueARwd',...
            'ProbCueAOmission','ProbCueBRwd','ProbCueBOmission',...
            'ProbCueCOmission','ProbUncuedRwd',...
            'ProbUncuedOmission','ProbCueAOpto',...
            'ProbCueBOpto','ProbCueCOpto','ProbCueARwdOpto',...
            'ProbCueBRwdOpto','ProbCueBOmissionOpto'};
       %%%%%%%%%%%%%%%%%
...
%% Task Parameters
    ...
    S.GUIPanels.Cue={'SoundType','SoundDuration','FreqA','FreqB','FreqC','SoundRamp','NbOfFreq','FreqWidth','SoundSamplingRate'};
